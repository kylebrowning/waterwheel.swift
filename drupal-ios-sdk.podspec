#
# Be sure to run `pod spec lint drupal-ios-sdk.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Kyle Browning" => "kylebrowning@me.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Kyle Browning', 'other author'
